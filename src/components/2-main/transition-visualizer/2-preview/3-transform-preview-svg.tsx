...
export const TransformPreview = forwardRef<MechanicalSpringHandle, { mode: TransformMode; }>(function TransformPreview({ mode }, ref) {
    ...
    return (
        <svg className="h-full w-full text-foreground" viewBox="0 0 700 550" role="img" aria-labelledby="transform-preview-title transform-preview-description">
            ...
            <g className="font-mono text-[15px]">
                <text className="fill-muted-foreground" x="100" y="520">
                    progress
                </text>
                <text className="fill-foreground" ref={valueRef} x="600" y="520" textAnchor="end">
                    0.000
                </text>
            </g>
        </svg>
